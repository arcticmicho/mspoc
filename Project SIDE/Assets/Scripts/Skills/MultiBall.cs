...
public class MultiBall : MonoBehaviour {
	...
	public void setMovement(float damage, float direction, float vertialDirection)
	{
		rigidbody2D.velocity = new Vector2(direction * movSpeed,verticalSpeed * vertialDirection);
		this.damage = damage;
	}
